...
def operacion(num):
    ...
    for i in range(len(lista)):
        ...
        while validar != True:
            print('-----------------------------------------------------------')
            #Se pide ingresar el primer numero
            num1 = input('Ingrese el primer numero (a): ')
        ...
        while validar != True:
            print('-----------------------------------------------------------')
            #Se pide ingresar el segundo numero
            num2 = input('Ingrese el segundo numero (b): ')
            #Si el usuario ingresa un valor entero, validar adquiere el valor true y se termina el bucle
            if num2.isnumeric():
                validar = True     
            #Si el usuario ingresa una cadena validar mantendra el valor de False, y empezará de nuevo este bucle secundario.
...
if __name__ == '__main__':
    ...
    """
    print('-----------------------------------------------------------')
    print('BIENVENIDO A SUMA SUCESIVA DEL MODELO y = (a + b**2)/2.5')
