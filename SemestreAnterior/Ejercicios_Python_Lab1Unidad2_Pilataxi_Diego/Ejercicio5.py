...
def operacion(num):
    ...
    for i in range(len(lista)):
        ...
        while validar != True:
            print('-----------------------------------------------------------')
            #Se pide ingresar la base de la expresión del ejercicio
            numBase = input('Ingrese el número base: ')
            ...
            #Si el usuario ingresa una cadena validar mantendra el valor de False, y empezará de nuevo este bucle secundario.
                ...
                validar = False
        validar = False
        #Se usa este bucle para el ingreso correcto del exponente de la expresion
        while validar != True:
            print('-----------------------------------------------------------')
            #Se ide ingresar el exponente de la expresion del ejercicio
            numExponente = input('Ingrese el exponente: ')
            #Si el usuario ingresa un valor entero, validar adquiere el valor True, y se termina el bucle secundario
...
if __name__ == '__main__':
    ...
    """
    print('-----------------------------------------------------------')
    print('BIENVENIDO A SUMA SUCESIVA DEL MODELO y = (x**z)/2')
