namespace ListasEjercicios
{
    class Nodo
    {
        ...
        {
            InsertarFinal("Diego Pilataxi");
            InsertarFinal("Jerly Reinoso");
            InsertarFinal("Joel Torres");
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            /*
            palabra = nodo.EliminarDespuesDe("d");
            nodo.Ver();
            Console.WriteLine("\nEl elemento eliminado fue: " + palabra);
            */

            /*
            palabra1 = nodo.EliminarAntesDe("c");
            nodo.Ver();
            Console.WriteLine("\nEl elemento eliminado fue: " + palabra1);
            */

            nodo.eliminarDesdeHasta(2, 4);
            nodo.Ver();
        }
    }
}